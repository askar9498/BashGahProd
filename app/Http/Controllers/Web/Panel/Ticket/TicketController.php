...
namespace App\Http\Controllers\Web\Panel\Ticket;
...
use function App\Http\Controllers\Web\Ticket\redirect;
use function App\Http\Controllers\Web\Ticket\view;
...
class TicketController extends Controller
{
    ...
    public function index(): View|\Illuminate\Foundation\Application|Factory|Application
    {
        ...
        return view('panels.user.tickets')->with(['title'=>'تیکت ها',
            'tickets'=> Ticket::whereUserId(\Auth::id())->with('unreadMessages')->orderByDesc('updated_at')->paginate(10),
