    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="#" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('assets/media/logo.png')); ?>" class="h-30px"/>
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <img src="<?php echo e(Auth::user()->photo->download_link??asset('assets/media/avatars/blank.png')); ?>" class="rounded-3" alt="user"/>
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="<?php echo e(Auth::user()->photo->download_link??asset('assets/media/avatars/blank.png')); ?>"/>
                                </div>
                                <!--end::Avatar-->
                                <!--begin::کاربرname-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?php echo e(Auth::user()-> first_name .' '. Auth::user()-> last_name??'کاربر'); ?>

                                        <span
                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">فعال</span>
                                    </div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?php echo e(''); ?></a>
                                </div>
                                <!--end::کاربرname-->
                            </div>
                        </div>
...
<!--end::Header-->
<?php /**PATH /app/resources/views/panels/admin/__header.blade.php ENDPATH**/ ?>