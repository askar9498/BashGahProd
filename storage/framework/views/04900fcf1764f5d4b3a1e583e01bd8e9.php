        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    لیست تاریخ های اعتبار بیمه تکمیلی درمان</h1>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <?php $__currentLoopData = $supplementary_insurance_validities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$supplementary_insurance_validity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($supplementary_insurance_validities->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($supplementary_insurance_validity->user->first_name); ?>

                                            - <?php echo e($supplementary_insurance_validity->user->last_name); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($supplementary_insurance_validity->start)->format('Y/m/d')); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($supplementary_insurance_validity->end)->format('Y/m/d')); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center flex-shrink-0">
                                                <a href="#" data-bs-toggle="tooltip" title="ویرایش زمان اعتبار"
                                                   ...
                                                   data-id="<?php echo e($supplementary_insurance_validity->id); ?>"
                                                   data-start="<?php echo e(Jalalian::forge($supplementary_insurance_validity->start)->format('Y/m/d')); ?>"
                                                   data-end="<?php echo e(Jalalian::forge($supplementary_insurance_validity->end)->format('Y/m/d')); ?>">
                        ...
                        <?php echo e($supplementary_insurance_validities->appends($_GET)->links('pagination::bootstrap-5')); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#updateCategoryButton').on('click', function (e) {
                ...
                $.ajax({
                        url: `/admin/supplementary-insurances/validities/${thisElement.data('id')}`,
                        type: 'PUT',
                        dataType: 'JSON',
                        headers: {
            ...
            $('#createCategoryButton').on('click', function (e) {
                ...
                showProgressButton(thisElement);
                $.ajax({
                        url: `/admin/supplementary-insurances/validities`,
                        type: 'POST',
                        dataType: 'JSON',
                        headers: {
                            'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/supplementary-insurances/validities.blade.php ENDPATH**/ ?>