        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    لیست درخواست های استفاده از خدمات روانشناختی</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">خدمات روانشناختی</li>
                </ul>
            </div>
            ...
            <div class="col-xl-10">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <tr class="border-0">
                                    ...
                                    <th class="p-3 min-w-100px ">تاریخ </th>
                                    <th class="p-3 min-w-100px "> نام مرکز </th>
                                ...
                                <?php $__currentLoopData = $psychological_use_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$psychological_use_request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($psychological_use_requests->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($psychological_use_request->user->first_name); ?> - <?php echo e($psychological_use_request->user->last_name); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($psychological_use_request->date)->format('Y/m/d')); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($psychological_use_request->center->name); ?>

                                        </td>
                                        <td class="text-table">
                                            <span class="badge <?php echo e(getRequestStatusBadgeClass($psychological_use_request->status)); ?>"> <?php echo e(getRequestStatusName($psychological_use_request->status)); ?></span>
                                        </td>
                        ...
                        <?php echo e($psychological_use_requests->appends($_GET)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/psychological-services/requests.blade.php ENDPATH**/ ?>