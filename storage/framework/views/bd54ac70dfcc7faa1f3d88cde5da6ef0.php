        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    لیست قراردادهای آموزشی اعضای باشگاه</h1>
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> لیست قراردادها</span>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <tr class="border-0">
                                    ...
                                    <th class="p-3 min-w-100px">شروع</th>
                                    <th class="p-3 min-w-100px">پایان</th>
                                    <th class="p-3 min-w-100px">موضوع</th>
                                    <th class="p-3 min-w-100px">عملیات</th>
                                </tr>
                                </thead>
                                <tbody class="transaction_table" id="transaction_table">
                                <?php $__currentLoopData = $educational_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$educational_course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($educational_courses->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($educational_course->user->first_name); ?>

                                            - <?php echo e($educational_course->user->last_name); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($educational_course->time); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($educational_course->start)->format('Y/m/d')); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($educational_course->end)->format('Y/m/d')); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($educational_course->subject->name); ?>
                        ...
                        <?php echo e($educational_courses->appends($_GET)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/educational-services/courses.blade.php ENDPATH**/ ?>