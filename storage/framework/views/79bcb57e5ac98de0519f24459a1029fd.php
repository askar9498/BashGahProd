                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> لیست  موضوعات</span>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <tr class="border-0">
                                    ...
                                    <th class="p-3 min-w-100px ">نام موضوع </th>
                                    <th class="p-3 min-w-100px ">عملیات</th>
                                </tr>
                                </thead>
                                <tbody class="transaction_table" id="transaction_table">
                                <?php $__currentLoopData = $educational_subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$educational_subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($educational_subjects->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($educational_subject->name); ?>
                        ...
                        <?php echo e($educational_subjects->appends($_GET)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/educational-services/subjects.blade.php ENDPATH**/ ?>