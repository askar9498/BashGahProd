        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">کارت رفاهی</li>
                </ul>
            </div>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <?php $__currentLoopData = $welfare_cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$welfare_card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($welfare_cards->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($welfare_card->user->first_name); ?> - <?php echo e($welfare_card->user->last_name); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($welfare_card->amount); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(Jalalian::forge($welfare_card->date)->format('Y/m/d')); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($welfare_card->description); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center flex-shrink-0">
                                                <a href="#" data-bs-toggle="tooltip" title="ویرایش پرداختی"
                                                   ...
                                                   data-id="<?php echo e($welfare_card->id); ?>"
                                                   data-amount="<?php echo e($welfare_card->amount); ?>"
                                                   data-user_id="<?php echo e($welfare_card->user_id); ?>"
                                                   data-description="<?php echo e($welfare_card->description); ?>"
                                                   data-date="<?php echo e(Jalalian::forge($welfare_card->date)->format('Y/m/d')); ?>">
                        ...
                        <?php echo e($welfare_cards->appends($_GET)->links('pagination::bootstrap-5')); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#updateCategoryButton').on('click', function (e) {
                ...
                $.ajax({
                        url: `/admin/welfare-cards/${thisElement.data('id')}`,
                        type: 'PUT',
                        dataType: 'JSON',
                        headers: {
                                ...
                                Swal.fire(
                                    {
                                        title: 'خطا',
                                        type: 'error',
                                        text: xhr.responseJSON.errors.date || xhr.responseJSON.errors.amount ||
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/welfare-cards/index.blade.php ENDPATH**/ ?>