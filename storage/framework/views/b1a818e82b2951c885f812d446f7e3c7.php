...
<?php $__env->startSection('main'); ?>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap">
                            ...
                            <div class="me-7 mb-4">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                     style="background-image: url('<?php echo e($user->photo->download_link??asset('assets/media/avatars/blank.png')); ?>')">
                                    <!--begin::نمایش existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px"
                                         style="background-image: url('<?php echo e($user->photo->download_link??asset('assets/media/avatars/blank.png')); ?>')"></div>
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#"
                                               class="text-gray-900 text-hover-primary fs-2 fw-bold me-1"><?php echo e($user->name); ?></a>
                                            <a href="#">
                                        ...
                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                            <a href="#"
                                               class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                ...
                                                </i><?php echo e($user->cellphone); ?></a>
                                            <a href="#"
                                               class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                                <i class="ki-duotone ki-sms fs-4">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i><?php echo e($user->email); ?></a>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::user-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2" id="user_config_button">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="#">تنظیمات</a>
                            </li>
                            <li class="nav-item mt-2" id="user_password_button">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="#">تغییر کلمه عبور</a>
                            </li>
                        </ul>
                        <!--begin::Navs-->
                    </div>
            ...
            <div class="card mb-5 mb-xl-10" id="user_config_section">
                <!--begin::کارت header-->
                    ...
                    <form id="kt_account_profile_details_form" class="form">
                        ...
                        <div class="card-body border-top p-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 fv-row">
                                            <input type="text" name="name" id="userName"
                                                   ...
                                                   placeholder="نام" value="<?php echo e($user->name); ?>"/>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="tel" id="userCellphone" name="phone" value="<?php echo e($user->cellphone); ?>"
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="tel" id="userEmail" name="email" value="<?php echo e($user->email); ?>"
                                           class="form-control form-control-lg form-control-solid"
            ...
            <div class="card mb-5 mb-xl-10 d-none" id="user_password_section">
                <!--begin::کارت header-->
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                     data-bs-target="#kt_account_profile_details" aria-expanded="true"
                     aria-controls="kt_account_profile_details">
    ...
    <script>
        ...
        $("#user_config_button").on('click', function () {
            $("#user_config_section").removeClass('d-none');
            $("#user_password_section").addClass('d-none');
            $(this).find('a').addClass('active');
            $("#user_password_button").find('a').removeClass('active');
        });

        $("#user_password_button").on('click', function () {
            $("#user_config_section").addClass('d-none');
            $("#user_password_section").removeClass('d-none');
            $(this).find('a').addClass('active');
            $("#user_config_button").find('a').removeClass('active');
        });
    </script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/profile.blade.php ENDPATH**/ ?>