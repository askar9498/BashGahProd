        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    لیست تعهدات بیمه عمر و حوادث</h1>
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> لیست تعهدات بیمه عمر و حوادث</span>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <?php $__currentLoopData = $life_accident_insurance_obligations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$life_accident_insurance_obligation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_obligations->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e(number_format($life_accident_insurance_obligation->amount)); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_obligation->description); ?>
                        ...
                        <?php echo e($life_accident_insurance_obligations->appends($_GET)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/life-accident-insurances/obligations.blade.php ENDPATH**/ ?>