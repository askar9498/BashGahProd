        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    لیست تاریخ های اعتبار بیمه عمر و حوادث</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">بیمه عمر و حوادث</li>
                </ul>
            </div>
                    ...
                    <div class="card-body pt-3">
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <?php $__currentLoopData = $life_accident_insurance_validities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$life_accident_insurance_validity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_validities->firstItem()+$key); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_validity->user->first_name); ?>

                                            - <?php echo e($life_accident_insurance_validity->user->last_name); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_validity->start?Jalalian::forge($life_accident_insurance_validity->start)->format('Y/m/d'):'--'); ?>

                                        </td>
                                        <td class="text-table">
                                            <?php echo e($life_accident_insurance_validity->end?Jalalian::forge($life_accident_insurance_validity->end)->format('Y/m/d'):'--'); ?>

                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center flex-shrink-0">
                                                <a href="#" data-bs-toggle="tooltip" title="ویرایش زمان اعتبار"
                                                   class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit_category"
                                                   data-id="<?php echo e($life_accident_insurance_validity->id); ?>"
                                                   data-start=" <?php echo e(Jalalian::forge($life_accident_insurance_validity->start)->format('Y/m/d')); ?>"
                                                   data-end=" <?php echo e(Jalalian::forge($life_accident_insurance_validity->end)->format('Y/m/d')); ?>"
                                                >
                        ...
                        <?php echo e($life_accident_insurance_validities->appends($_GET)->links('pagination::bootstrap-5')); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#updateCategoryButton').on('click', function (e) {
                ...
                $.ajax({
                        url: `/admin/life-accident-insurances/validities/${thisElement.data('id')}`,
                        type: 'PUT',
                        dataType: 'JSON',
                        headers: {
            ...
            $('#createCategoryButton').on('click', function (e) {
                ...
                showProgressButton(thisElement);
                $.ajax({
                        url: `/admin/life-accident-insurances/validities`,
                        type: 'POST',
                        dataType: 'JSON',
                        headers: {
                            'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
                                    ...
                                    Swal.fire(
                                        {
                                            title: 'خطا',
                                            type: 'error',
                                            text: 'زمان اعتبار مورد نظر یافت نشد!',
                                            confirmButtonText: 'باشه'
                                        });
                                } else {
                                    Swal.fire(
...
<?php echo $__env->make('panels.admin._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/panels/admin/life-accident-insurances/validities.blade.php ENDPATH**/ ?>